...
func (a *AdminAccountService) AdminLogin(req *request.AdminLoginReq) (err error, admin *admin_model.Admin, adminToken *admin_model.AdminToken) {
...
func (a *AdminAccountService) FindAdminToken(token string) (adminToken *admin_model.AdminToken, err error) {
